	...
	public function all_available_features(): array {
		...
		return array(
			...
			'google_pay'                      => array(
				...
				'notes'       => array( __( '¹PayPal Q2 Earnings-2021.', 'woocommerce-paypal-payments' ) ),
			),
			'apple_pay'                       => array(
			...
			'pay_later'                       => array(
				...
				'description' => __( 'Let customers know they can buy now and pay later with PayPal. Adding this messaging can boost conversion rates and increase cart sizes by 39%¹, with no extra cost to you—plus, you get paid up front.', 'woocommerce-paypal-payments' ),
			...
			'installments'                    => array(
				...
				'description' => __( 'Allow your customers to pay in installments without interest while you receive the full payment.*', 'woocommerce-paypal-payments' ) . '<p>' . __( 'Activate your Installments without interest with PayPal.', 'woocommerce-paypal-payments' ) . '</p>' . '<p>' . sprintf(
