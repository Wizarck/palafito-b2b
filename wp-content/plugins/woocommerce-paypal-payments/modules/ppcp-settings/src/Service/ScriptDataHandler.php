...
class ScriptDataHandler {
	...
	public function localize_scripts( string $hook_suffix ): void {
		...
		$disabled_cards_choices              = array(
			...
			array(
				'value' => 'mastercard',
				'label' => _x( 'Mastercard', 'Name of credit card', 'woocommerce-paypal-payments' ),
			),
			array(
				'value' => 'amex',
				'label' => _x( 'American Express', 'Name of credit card', 'woocommerce-paypal-payments' ),
			),
			array(
				'value' => 'discover',
				'label' => _x( 'Discover', 'Name of credit card', 'woocommerce-paypal-payments' ),
			),
			array(
				'value' => 'jcb',
				'label' => _x( 'JCB', 'Name of credit card', 'woocommerce-paypal-payments' ),
			),
			array(
				'value' => 'elo',
				'label' => _x( 'Elo', 'Name of credit card', 'woocommerce-paypal-payments' ),
			),
			array(
				'value' => 'hiper',
		...
		$script_data                         = array(
			'assets'                          => array( 'imagesUrl' => $module_url . '/images/' ),
