			...
			return $insert_after(
				...
				array(
					'googlepay_button_enabled' => array(
						...
						'title_html'        => sprintf( '<img src="%sassets/images/googlepay.svg" alt="%s" style="max-width: 150px; max-height: 45px;" />', $module_url, __( 'Google Pay', 'woocommerce-paypal-payments' ) ),
						'type'              => 'checkbox',
						'class'             => array( 'ppcp-grayed-out-text' ),
						'input_class'       => array( 'ppcp-disabled-checkbox' ),
						'label'             => __( 'Enable Google Pay button', 'woocommerce-paypal-payments' ) . '<p class="description">' . sprintf(
						...
						'gateway'           => 'dcc',
						'requirements'      => array(),
						'custom_attributes' => array( 'data-ppcp-display' => wp_json_encode( array( $display_manager->rule()->condition_is_true( \false )->action_enable( 'googlepay_button_enabled' )->to_array() ) ) ),
						'classes'           => array(
		...
		return $insert_after(
			...
			array(
				'googlepay_button_enabled'          => array(
					...
					'custom_attributes' => array(
						'data-ppcp-display'    => wp_json_encode(
							array(
								$display_manager->rule()->condition_element(
									'googlepay_button_enabled',
									'1'
								)->action_visible( 'googlepay_button_type' )->action_visible( 'googlepay_button_color' )->action_visible( 'googlepay_button_language' )->action_visible( 'googlepay_button_shipping_enabled' )->action_visible( 'googlepay_button_preview' )->action_class(
									'googlepay_button_enabled',
									'active'
								)->to_array(),
							)
				...
				'googlepay_button_shipping_enabled' => array(
					...
					'label'        => __(
						'Enable Google Pay shipping callback',
						'woocommerce-paypal-payments'
					),
					'default'      => 'no',
					'screens'      => array( State::STATE_ONBOARDED ),
