	...
	public function to_array(): array {
		return array(
			'authorizations' => array_map(
				static function ( \WooCommerce\PayPalCommerce\ApiClient\Entity\Authorization $authorization ): array {
					return $authorization->to_array();
				},
				$this->authorizations()
			),
			'captures'       => array_map(
				static function ( \WooCommerce\PayPalCommerce\ApiClient\Entity\Capture $capture ): array {
					return $capture->to_array();
				},
				$this->captures()
			),
			'refunds'        => array_map(
				static function ( \WooCommerce\PayPalCommerce\ApiClient\Entity\Refund $refund ): array {
