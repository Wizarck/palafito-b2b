...
class Token {
	...
	public function vaulting_available(): bool {
		...
		if ( strpos( $this->json->scope, 'https://uri.paypal.com/services/vault/payment-tokens/readwrite' ) !== \false ) {
			return \true;
		}
		return \false;
	}
	...
	public function is_tracking_available(): bool {
		...
		if ( strpos( $this->json->scope, 'https://uri.paypal.com/services/shipping/trackers/readwrite' ) !== \false ) {
			return \true;
		}
		return \false;
	}
