...
class SellerStatus {
	...
	public function to_array(): array {
		$products     = array_map(
			function ( \WooCommerce\PayPalCommerce\ApiClient\Entity\SellerStatusProduct $product ): array {
				return $product->to_array();
			},
			$this->products()
		);
		$capabilities = array_map(
			function ( \WooCommerce\PayPalCommerce\ApiClient\Entity\SellerStatusCapability $capability ): array {
