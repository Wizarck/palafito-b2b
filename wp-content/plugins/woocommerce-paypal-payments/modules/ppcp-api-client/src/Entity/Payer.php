...
class Payer {
	 ...
	 */
	public function name(): ?\WooCommerce\PayPalCommerce\ApiClient\Entity\PayerName {
		return $this->name;
	}
	/**
	 * Sets the name.
	 ...
	 */
	public function set_name( ?\WooCommerce\PayPalCommerce\ApiClient\Entity\PayerName $name ): void {
		$this->name = $name;
	}
	/**
	 ...
	 */
	public function set_address( ?\WooCommerce\PayPalCommerce\ApiClient\Entity\Address $address ): void {
		$this->address = $address;
	}
	/**
	 * Returns the phone.
