...
class SellerReceivableBreakdownFactory {
	 ...
	 */
	public function __construct( \WooCommerce\PayPalCommerce\ApiClient\Factory\MoneyFactory $money_factory, \WooCommerce\PayPalCommerce\ApiClient\Factory\ExchangeRateFactory $exchange_rate_factory, \WooCommerce\PayPalCommerce\ApiClient\Factory\PlatformFeeFactory $platform_fee_factory ) {
	...
	public function from_paypal_response( stdClass $data ): SellerReceivableBreakdown {
		...
		return new SellerReceivableBreakdown( $gross_amount, $paypal_fee, $paypal_fee_in_receivable_currency, $net_amount, $receivable_amount, $exchange_rate, $platform_fees );
	}
}
