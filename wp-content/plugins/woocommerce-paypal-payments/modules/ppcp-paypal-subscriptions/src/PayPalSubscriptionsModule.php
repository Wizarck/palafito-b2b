...
class PayPalSubscriptionsModule implements ServiceModule, ExtendingModule, ExecutableModule {
	...
	public function run( ContainerInterface $c ): bool {
					...
					array(
						'ajax'       => array(
							'deactivate_plan' => array(
								'endpoint' => \WC_AJAX::get_endpoint( \WooCommerce\PayPalCommerce\PayPalSubscriptions\DeactivatePlanEndpoint::ENDPOINT ),
								'nonce'    => wp_create_nonce( \WooCommerce\PayPalCommerce\PayPalSubscriptions\DeactivatePlanEndpoint::ENDPOINT ),
							),
						),
		...
		add_action(
			'wc_ajax_' . \WooCommerce\PayPalCommerce\PayPalSubscriptions\DeactivatePlanEndpoint::ENDPOINT,
			function () use ( $c ) {
