...
class CustomerApprovalListener {
	...
	public function listen(): void {
		...
		try {
			...
			$this->add_wc_error_notice( __( 'This PayPal account is already saved on this site. Please check that you are logged in correctly.', 'woocommerce-paypal-payments' ) );
