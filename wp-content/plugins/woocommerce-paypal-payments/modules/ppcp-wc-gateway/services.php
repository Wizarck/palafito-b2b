...
return array(
	...
	'wcgateway.send-only-countries'                        => static function () {
		return array( 'AO', 'AI', 'AM', 'AW', 'AZ', 'BY', 'BJ', 'BT', 'BO', 'VG', 'BN', 'BF', 'BI', 'CI', 'KH', 'CM', 'CV', 'TD', 'KM', 'CG', 'CK', 'DJ', 'ER', 'ET', 'FK', 'GA', 'GM', 'GN', 'GW', 'GY', 'KI', 'KG', 'LA', 'MK', 'MG', 'MV', 'ML', 'MH', 'MR', 'YT', 'FM', 'MN', 'ME', 'MS', 'NA', 'NR', 'NP', 'NE', 'NG', 'NU', 'NF', 'PG', 'PY', 'PN', 'RW', 'ST', 'WS', 'SL', 'SB', 'SO', 'SH', 'PM', 'VC', 'SR', 'SJ', 'TJ', 'TZ', 'TG', 'TO', 'TN', 'TM', 'TV', 'UG', 'UA', 'VA', 'WF', 'YE', 'ZM', 'ZW' );
	},
	...
	'wcgateway.order-processor'                            => static function ( ContainerInterface $container ): OrderProcessor {
		...
		return new OrderProcessor( $session_handler, $order_endpoint, $order_factory, $threed_secure, $authorized_payments_processor, $settings, $logger, $environment, $subscription_helper, $order_helper, $container->get( 'api.factory.purchase-unit' ), $container->get( 'api.factory.payer' ), $container->get( 'api.factory.shipping-preference' ) );
	},
	...
	'wcgateway.settings.fields'                            => static function ( ContainerInterface $container ): array {
		...
		$fields = array(
			...
			'description'                     => array(
				...
				'default'      => __( 'Pay via PayPal; you can pay with your credit card if you don\'t have a PayPal account.', 'woocommerce-paypal-payments' ),
				'screens'      => array( State::STATE_START, State::STATE_ONBOARDED ),
				'requirements' => array(),
				'gateway'      => 'paypal',
			),
			'intent'                          => array(
				...
				'default'      => 'capture',
				'desc_tip'     => \true,
				'description'  => __( 'The intent to either capture payment immediately or authorize a payment for an order after order creation.', 'woocommerce-paypal-payments' ),
				'options'      => array(
			...
			'capture_on_status_change'        => array(
				...
				'default'      => \false,
				'desc_tip'     => \true,
				'description'  => __( 'The transaction will be captured automatically when the order status changes to Processing or Completed.', 'woocommerce-paypal-payments' ),
			...
			'capture_for_virtual_only'        => array(
				...
				'default'      => \false,
				'desc_tip'     => \true,
				'description'  => __( 'If the order contains exclusively virtual items, enable this to immediately capture, rather than authorize, the transaction.', 'woocommerce-paypal-payments' ),
			...
			'brand_name'                      => array(
				...
				'desc_tip'     => \true,
				'description'  => __( 'Control the name of your shop, customers will see in the PayPal process.', 'woocommerce-paypal-payments' ),
				'screens'      => array( State::STATE_START, State::STATE_ONBOARDED ),
				'requirements' => array(),
				'gateway'      => 'paypal',
			),
			'landing_page'                    => array(
				...
				'desc_tip'     => \true,
				'description'  => __( 'Type of PayPal page to display.', 'woocommerce-paypal-payments' ),
				'options'      => array(
			...
			'card_billing_data_mode'          => array(
				...
				'options'      => array(
					\WooCommerce\PayPalCommerce\WcGateway\CardBillingMode::USE_WC => __( 'Use WC checkout form data (do not show any address fields)', 'woocommerce-paypal-payments' ),
					\WooCommerce\PayPalCommerce\WcGateway\CardBillingMode::MINIMAL_INPUT => __( 'Request only name and postal code', 'woocommerce-paypal-payments' ),
					\WooCommerce\PayPalCommerce\WcGateway\CardBillingMode::NO_WC => __( 'Do not use WC checkout form data (request all address fields)', 'woocommerce-paypal-payments' ),
				),
				'screens'      => array( State::STATE_START, State::STATE_ONBOARDED ),
				'requirements' => array(),
			...
			'disable_cards'                   => array(
				...
				'default'      => array(),
				'desc_tip'     => \true,
				'description'  => __( 'By default all possible credit cards will be accepted. You can disable some cards, if you wish.', 'woocommerce-paypal-payments' ),
				'options'      => array(
					'visa'       => _x( 'Visa', 'Name of credit card', 'woocommerce-paypal-payments' ),
					'mastercard' => _x( 'Mastercard', 'Name of credit card', 'woocommerce-paypal-payments' ),
					'amex'       => _x( 'American Express', 'Name of credit card', 'woocommerce-paypal-payments' ),
			...
			'card_icons'                      => array(
				...
				'default'      => array(),
				'desc_tip'     => \true,
				'description'  => __( 'Define which cards you want to display in your checkout.', 'woocommerce-paypal-payments' ),
				'options'      => array(
	...
	'wcgateway.is-fraudnet-enabled'                        => static function ( ContainerInterface $container ): bool {
		$settings = $container->get( 'wcgateway.settings' );
		assert( $settings instanceof Settings );
		if ( apply_filters( 'woocommerce.feature-flags.woocommerce_paypal_payments.settings_enabled', getenv( 'PCP_SETTINGS_ENABLED' ) === '1' ) ) {
			return \true;
		}
