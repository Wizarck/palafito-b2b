...
class SectionsRenderer {
	...
	private function sections(): array {
		$sections = array(
			\WooCommerce\PayPalCommerce\WcGateway\Settings\Settings::CONNECTION_TAB_ID => __( 'Connection', 'woocommerce-paypal-payments' ),
			PayPalGateway::ID         => __( 'Standard Payments', 'woocommerce-paypal-payments' ),
			\WooCommerce\PayPalCommerce\WcGateway\Settings\Settings::PAY_LATER_TAB_ID => __( 'Pay Later', 'woocommerce-paypal-payments' ),
