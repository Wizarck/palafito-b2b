...
$i++;
$cfg['Servers'][$i]['host'] 			= 'db5016482050.hosting-data.io';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= ':SPRp!_xfTjcRkHOr(]:i=~Ow8)miQ*,' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_tLMzZWVRNPKC9jsax2A8TQh/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://palafitofood.com/wp-admin/?rand=50617854&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://palafitofood.com/wp-admin/?rand=51096878&pma_logout=1';
