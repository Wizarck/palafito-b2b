...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File;

use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Common\Functions\Strings;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\PrivateKey;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Common\PublicKey;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\DSA;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\EC;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Hash;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\PublicKeyLoader;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\Random;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\RSA;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\ASN1\Element;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\ASN1\Maps;
use WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Math\BigInteger;
...
class X509
{
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\X509::getDN()
     */
    const DN_ARRAY = 0;
    /**
     * Return string
     ...
     *
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\X509::saveX509()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\X509::saveCSR()
     * @see \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\X509::saveCRL()
     */
    const FORMAT_PEM = 0;
    /**
     * Save as DER
    ...
    public function saveX509(array $cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \phpseclib3\File\ASN1::TYPE_IA5_STRING.
           \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(['\WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\File\X509', 'dnsName'], $subject->domains);
        }
    ...
    public function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \WPO\WC\PDF_Invoices_Pro\Vendor\phpseclib3\Crypt\RSA).
