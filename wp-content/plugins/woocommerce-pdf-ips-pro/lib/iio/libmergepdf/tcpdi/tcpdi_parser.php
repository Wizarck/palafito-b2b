<?php
//============================================================+
// File name   : WPO_WCPDF_IPS_PRO_tcpdi_parser.php
// Version     : 1.1
// Begin       : 2013-09-25
...
//
// This file is for use with the WPO_WCPDF_IPS_PRO_TCPDF software library.
//
// WPO_WCPDF_IPS_PRO_tcpdi_parser is free software: you can redistribute it and/or modify it
// under the terms of the GNU Lesser General Public License as
// published by the Free Software Foundation, either version 3 of the
// License, or (at your option) any later version.
//
// WPO_WCPDF_IPS_PRO_tcpdi_parser is distributed in the hope that it will be useful, but
// WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
// See the GNU Lesser General Public License for more details.
//
// You should have received a copy of the License
// along with WPO_WCPDF_IPS_PRO_tcpdi_parser. If not, see
...
/**
 * @class WPO_WCPDF_IPS_PRO_tcpdi_parser
 * This is a PHP class for parsing PDF documents.<br>
 * Based on WPO_WCPDF_IPS_PRO_TCPDF_PARSER, part of the WPO_WCPDF_IPS_PRO_TCPDF project by Nicola Asuni.
...
// -----------------------------------------------------------------------------
    ...
    public function __construct($data, $uniqueid) {
        ...
        $this->FilterDecoders = new WPO_WCPDF_IPS_PRO_TCPDF_FILTERS();
...
} // END OF WPO_WCPDF_IPS_PRO_TCPDF_PARSER CLASS
