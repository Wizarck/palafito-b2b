...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\League\OAuth2\Client\Grant;

use WPO\WC\PDF_Invoices_Pro\Vendor\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'WPO\\WC\\PDF_Invoices_Pro\\Vendor\\League\\OAuth2\\Client\\Grant\\' . $class;
