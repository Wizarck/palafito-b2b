...
class Settings {
	...
	public function init_settings() {
		...
		$settings_fields = array(
			...
			array(
				...
				'id'       => 'static_file',
				'title'    => __( 'Static files', 'wpo_wcpdf_pro' ),
				'callback' => class_exists( '\\Polylang' ) ? 'i18n_wrap' : array( $this, 'multiple_file_upload_callback' ),
				'section'  => 'static_files',
				'args'     => array(
					'callback'             => class_exists( '\\Polylang' ) ? array( $this, 'multiple_file_upload_callback' ) : '',
		...
		$multilingual_settings_fields = array(
			...
			array(
				...
				'args'     => array(
					'option_name' => $option_name,
					'id'          => 'document_language',
					'options'     => array( '' => __( 'Select...', 'wpo_wcpdf_pro' ) ) + $multilingual_html_plugins + $user_language + array(
		...
		$settings_fields = array_merge( $settings_fields, $rest_api_settings );
	...
	public function multiple_file_upload_callback( array $args ): void {
		...
		// multilingual file
		if ( isset( $lang ) && isset( $options[ $id ][ $lang ] ) ) {
