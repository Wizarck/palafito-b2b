<?php
/**
 * Customer Facturado Email
 *
 * An email sent to the customer when the order is marked as "Facturado".
 *
 * @class       WC_Email_Customer_Facturado
 * @extends     WC_Email
...
if ( ! class_exists( 'WC_Email_Customer_Facturado' ) ) :
	...
	class WC_Email_Customer_Facturado extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Pedido facturado', 'palafito-wc-extensions' );
			$this->description    = __( 'Este email se envía al cliente cuando el pedido se marca como "Facturado".', 'palafito-wc-extensions' );
...
return new WC_Email_Customer_Facturado();
